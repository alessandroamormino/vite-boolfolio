...
<template>
  <footer :class="this.store.darkMode ? 'dark-mode' : 'light-mode'">
    <div class="footer-content">
      ...
      <div class="right">
        <em>Made by Alessandro Amormino</em>
      </div>
    </div>
  </footer>
</template>
